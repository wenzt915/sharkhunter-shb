...
my $config_tag1 = '5.12.2 - Thu Dec  9 04:00:41 2010';

my $patchlevel_date = 1291896017;
my $patch_tags = '+ACTIVEPERL_LOCAL_PATCHES_ENTRY +1fd8fa4 +f120055 +a2a8d15 +007cfe1 +6d8f7c9 +d956618 +321e50c ';
my @patches = (
