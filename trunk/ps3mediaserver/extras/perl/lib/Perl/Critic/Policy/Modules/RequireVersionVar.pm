##############################################################################
#      $URL: http://perlcritic.tigris.org/svn/perlcritic/branches/Perl-Critic-1.109/lib/Perl/Critic/Policy/Modules/RequireVersionVar.pm $
...
A common practice is to use the C<$Revision: 3911 $> keyword to
automatically define the C<$VERSION> variable like this:

    our ($VERSION) = '$Revision: 3911 $' =~ m{ \$Revision: \s+ (\S+) }x;
